...
func (_m *IComputerStorage) GetModePoff() (string, error) {
	ret := _m.Called()
...
func (_m *IComputerStorage) GetTimePoff() (string, error) {
	ret := _m.Called()
...
func (_m *IComputerStorage) SetPoff(pc entity.MyPc) error {
	ret := _m.Called(pc)
...
// NewIComputerStorage creates a new instance of IComputerStorage. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIComputerStorage(t interface {
	mock.TestingT
	Cleanup(func())
}) *IComputerStorage {
	mock := &IComputerStorage{}
	mock.Mock.Test(t)
